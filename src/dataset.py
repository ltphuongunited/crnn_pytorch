...
class KalapaDataset(Dataset):
    ...
    def __init__(self, root_dir=None, mode=None, paths=None, img_height=32, img_width=100, transform=None):
        ...
        for file_name in file_names:
            ...
            with open(os.path.join(file_path), 'r') as fr:
                for line in fr.readlines():
                    ...
                    path = os.path.join(root_dir, 'images', path)
                    paths.append(path)
                    texts.append(text)
...
# print('Jello')
# x = KalapaDataset('OCR/training_data', 'train')
# print(len(x))
